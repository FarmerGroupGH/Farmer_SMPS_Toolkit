...
Window SMPS_Data_Processor() : Panel
	...
	NewPanel /W=(890,52,1912,986) as "SMPS_DataViewer_FarmerGroup"
	...
	Button help_butt,pos={775.00,172.00},size={105.00,39.00},proc=help_button,title="Help"
	...
	Button Killallgraphs_butt,pos={645.00,72.00},size={125.00,44.00},proc=Kill_All_Graphs_button,title="Kill All Graphs"
	...
	Button Kill_All_Tables_Button,pos={645.00,121.00},size={125.00,44.00},proc=Kill_All_Tables_button,title="Kill All Tables"
	...
	Button Kill_All_Data,pos={645.00,171.00},size={125.00,44.00},proc=KillAllData_button,title="Kill All Data"
...
Function PP_CreateMaskTime_Series()
	...
	setdatafolder root:Post_Processing
	wave Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total
	//If the waves exist
	if(waveexists(Mask_Datetime)==1 && waveexists(Mask_NConc_Total)==1 && waveexists(Mask_MConc_Total)==1)
	...
	elseif(waveexists(Mask_Datetime)==0 && waveexists(Mask_NConc_Total)==0 && waveexists(Mask_MConc_Total)==0)
		wave datetimewave_base, NConc_Total_base, MConc_Total_base
...
Function PP_Set_Flags()
	setdatafolder root:Post_Processing
	wave Flag_Wave, Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total
	setdatafolder root:
	...
	killwindow/Z $S_Name
	edit/N=$S_Name
	appendtotable Flag_Wave, Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total
...
Function PP_Mask_Data()
	...
	setdatafolder root:Post_Processing
	wave Flag_Wave, Mask_DateTime, Mask_NConc_Total, Mask_MConc_Total //Datetimewave_base
	...
	//Check to see if we have Number and Mass Total [] waves
	if(waveexists(Mask_NConc_Total)==0)
		print "Error: Must have a Mask Number Concentration Wave" 
		return -1
	elseif(waveexists(Mask_MConc_Total)==0)
