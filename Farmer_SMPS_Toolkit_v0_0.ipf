...
Window SMPS_Data_Processor() : Panel
	...
	NewPanel /W=(760,55,1641,895) as "SMPS_DataViewer_FarmerGroup"
	...
	TitleBox Title01,pos={11.00,9.00},size={309.00,24.00},title="Farmer Lab SMPS Data Processor"
	TitleBox Title01,help={"This Processor can only work with AIM 10.3 Files"}
	TitleBox Title01,fSize=20,frame=0
	TitleBox Title02,pos={397.00,11.00},size={271.00,19.00},title="Adam De Groodt and Lauren Garofalo"
	...
	TitleBox Title03,pos={448.00,41.00},size={187.00,42.00},title="Correspondence to\rAdam.De_Groodt@colostate.edu\rOr Lauren.Garofalo@colostate.edu"
	...
	Button help_butt,pos={753.00,182.00},size={105.00,39.00},proc=help_button,title="Help"
	...
	TitleBox cumulative_title,pos={14.00,227.00},size={184.00,24.00},title="Plot a full time series"
	...
	TitleBox ICARTT_title,pos={15.00,636.00},size={179.00,24.00},title="Make ICARTT Table"
	...
	TitleBox SDwork,pos={15.00,490.00},size={164.00,24.00},title="Plot individual files"
	...
	TitleBox expworktitlebox,pos={21.00,366.00},size={228.00,24.00},title="Plot a specific time period"
	...
	SetVariable setvar0,pos={18.00,88.00},size={362.00,35.00},title="\\Z20Assumed Density of Aerosol, g cm\\S-3"
	...
	SetVariable indivfile_Y,pos={265.00,533.00},size={65.00,17.00},title="Year"
	SetVariable indivfile_Y,limits={-inf,inf,0},value= indivfile_Y
	SetVariable indivfile_Y1,pos={269.00,554.00},size={65.00,17.00},title="Month"
	SetVariable indivfile_Y1,limits={-inf,inf,0},value= indivfile_Mon
	SetVariable indivfile_Y2,pos={265.00,575.00},size={65.00,17.00},title="Day"
	SetVariable indivfile_Y2,limits={-inf,inf,0},value= indivfile_D
	SetVariable indivfile_Y3,pos={347.00,557.00},size={65.00,17.00},title="Minute"
	SetVariable indivfile_Y3,limits={-inf,inf,0},value= indivfile_Min
	SetVariable indivfile_Y4,pos={349.00,534.00},size={65.00,17.00},title="Hour"
	SetVariable indivfile_Y4,limits={-inf,inf,0},value= indivfile_H
	SetVariable indivfile_Y5,pos={348.00,578.00},size={65.00,17.00},title="Second"
	...
	SetVariable indivfile_Y6,pos={45.00,414.00},size={65.00,17.00},title="Year"
	SetVariable indivfile_Y6,limits={-inf,inf,0},value= avg_start_Y
	SetVariable indivfile_Y7,pos={47.00,434.00},size={65.00,17.00},title="Month"
	SetVariable indivfile_Y7,limits={-inf,inf,0},value= avg_start_Mon
	SetVariable indivfile_Y8,pos={46.00,457.00},size={65.00,17.00},title="Day"
	SetVariable indivfile_Y8,limits={-inf,inf,0},value= avg_start_D
	SetVariable indivfile_Y9,pos={135.00,433.00},size={65.00,17.00},title="Minute"
	SetVariable indivfile_Y9,limits={-inf,inf,0},value= avg_start_Min
	SetVariable indivfile_Y0,pos={135.00,411.00},size={65.00,17.00},title="Hour"
	SetVariable indivfile_Y0,limits={-inf,inf,0},value= avg_start_H
	SetVariable indivfile_Y06,pos={135.00,454.00},size={65.00,17.00},title="Second"
	SetVariable indivfile_Y06,limits={-inf,inf,0},value= avg_start_S
	SetVariable indivfile_Y07,pos={229.00,415.00},size={65.00,17.00},title="Year"
	SetVariable indivfile_Y07,limits={-inf,inf,0},value= avg_stop_Y
	SetVariable indivfile_Y08,pos={234.00,437.00},size={65.00,17.00},title="Month"
	SetVariable indivfile_Y08,limits={-inf,inf,0},value= avg_stop_Mon
	SetVariable indivfile_Y09,pos={242.00,459.00},size={65.00,17.00},title="Day"
	SetVariable indivfile_Y09,limits={-inf,inf,0},value= avg_stop_D
	SetVariable indivfile_Y10,pos={311.00,435.00},size={65.00,17.00},title="Minute"
	SetVariable indivfile_Y10,limits={-inf,inf,0},value= avg_stop_Min
	SetVariable indivfile_Y01,pos={311.00,413.00},size={65.00,17.00},title="Hour"
	SetVariable indivfile_Y01,limits={-inf,inf,0},value= avg_stop_H
	SetVariable indivfile_Y11,pos={311.00,456.00},size={65.00,17.00},title="Second"
	...
	SetVariable indivfile_Y12,pos={387.00,671.00},size={65.00,17.00},title="Year"
	SetVariable indivfile_Y12,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstart_Y
	SetVariable indivfile_Y13,pos={388.00,690.00},size={65.00,17.00},title="Month"
	SetVariable indivfile_Y13,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstart_M
	SetVariable indivfile_Y14,pos={387.00,714.00},size={65.00,17.00},title="Day"
	SetVariable indivfile_Y14,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstart_D
	SetVariable indivfile_Y15,pos={476.00,690.00},size={65.00,17.00},title="Month"
	SetVariable indivfile_Y15,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstop_M
	SetVariable indivfile_Y02,pos={476.00,668.00},size={65.00,17.00},title="Year"
	SetVariable indivfile_Y02,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstop_Y
	SetVariable indivfile_Y16,pos={476.00,711.00},size={65.00,17.00},title="Day"
	...
	SetVariable Interval,pos={444.00,398.00},size={127.00,31.00},bodyWidth=21,title="\\JRPlot every nth scan\rinterval:"
	...
	SetVariable UTCoffset,pos={39.00,691.00},size={130.00,17.00},title="UTC = Local ST + "
	SetVariable UTCoffset,limits={-inf,inf,0},value= UTC_offset_StandardTime
	CheckBox Export_Check,pos={388.00,91.00},size={245.00,14.00},proc=Export_CheckProc,title="Export CSVs and figures of individual files?"
	CheckBox Export_Check,variable= Check_Box_Export_Single_File
	CheckBox Create_Symbolic_Path_for_Export_checkbox,pos={386.00,111.00},size={206.00,28.00},proc=Create_Symbolic_Path_for_Export_checkboxProc,title="Save exported files to one location?\r (Only works with multiload)"
	CheckBox Create_Symbolic_Path_for_Export_checkbox,value= 0
	TitleBox PP_title1,pos={15.00,760.00},size={146.00,24.00},title="Post-Processing"
	...
	SetVariable PP_SetVar_VersionNumber,pos={160.00,767.00},size={140.00,17.00},title="Version Number"
	...
	SetVariable PP_SetVar_FlagWave_StartAdjust,pos={20.00,861.00},size={201.00,17.00},title="Flag Wave Start Index"
	SetVariable PP_SetVar_FlagWave_StartAdjust,limits={0,inf,1},value= PP_FlagWave_Start
	SetVariable PP_SetVar_FlagWave_Value,pos={22.00,902.00},size={201.00,17.00},title="Flag Wave Value"
	SetVariable PP_SetVar_FlagWave_Value,value= PP_FlagWave_Value
	SetVariable PP_SetVar_FlagWave_EndAdjust2,pos={22.00,882.00},size={201.00,17.00},title="Flag Wave End Index"
	...
	SetVariable setvar1,pos={30.00,301.00},size={146.00,17.00},title="Minimum Diameter"
	SetVariable setvar1,limits={-inf,inf,0},value= MinimumDiameter
	SetVariable setvar2,pos={30.00,324.00},size={146.00,17.00},title="Maximum Diameter"
...
function help_button_for_button()
	...
	Notebook # text="\r"
	Notebook # text="\r"
	Notebook # text="Autogenerated Graphs when loading datafiles - This section needs editing"  
	Notebook # text="	A. Graph1. NConc_Total vs datetimewave\r"
	Notebook # text="		Time series of integrated number concentration both\r"
	...
	Notebook # text="\r"
	Notebook # text="	B. AIM_Igor_Difference\r"
	...
	Notebook # text="\r"
	Notebook # text="	D. Graph0. NConc_Total vs datetimewave\r"
...
function gdatanumb()  // Load onefile files
   ...
   NVAR densityconv = root:density
	...
	//Expected number of bins from panel
...
//	Endfor
	...
	// Make an excel friendly datetimewave
	wave Excel_Datetime
...
//Due to the restructuring of the code to perform both number and mass operations done at once by AJD on 20231228 the following lines move the Mass waves to a created mass folder
...
//	If (waveexists(MConc_Total_Stats))
...
Function checkdiameters()
	...
	Else 
		doalert/T="Diameter Check" 1, "The following files have different diameter bins from the first file:/r" + sepdiam_strname[1]
