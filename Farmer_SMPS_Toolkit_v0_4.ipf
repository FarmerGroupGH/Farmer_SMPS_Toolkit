...
Window SMPS_Data_Processor() : Panel
	...
	NewPanel /W=(178,52,1200,986) as "SMPS_DataViewer_FarmerGroup"
	ModifyPanel cbRGB=(61166,61166,61166), frameStyle=1, frameInset=7
	SetDrawLayer UserBack
	DrawPICT 773,18,0.236686,0.236686,PICT_0
	...
	TitleBox Title01,pos={11.00,9.00},size={291.00,28.00},title="Farmer Lab SMPS Data Processor"
	TitleBox Title01,help={"This Processor can only work with AIM 10.3 Files"}
	TitleBox Title01,fSize=20,frame=0
	TitleBox Title02,pos={397.00,11.00},size={268.00,23.00},title="Adam De Groodt and Lauren Garofalo"
	...
	TitleBox Title03,pos={448.00,41.00},size={182.00,48.00},title="Correspondence to\rAdam.De_Groodt@colostate.edu\rOr Lauren.Garofalo@colostate.edu"
	...
	Button process_databutt,pos={14.00,127.00},size={262.00,33.00},proc=LoadOneFile_Button,title="Load and Process One File"
	...
	Button help_butt,pos={826.00,122.00},size={117.00,45.00},proc=help_button,title="Help"
	...
	TitleBox cumulative_title,pos={14.00,223.00},size={183.00,28.00},title="Plot a full time series"
	...
	TitleBox ICARTT_title,pos={19.00,653.00},size={168.00,28.00},title="Make ICARTT Table"
	...
	TitleBox SDwork,pos={15.00,490.00},size={166.00,28.00},title="Plot individual files"
	...
	Button Killallgraphs_butt,pos={677.00,72.00},size={125.00,44.00},proc=Kill_All_Graphs_button,title="Kill All Graphs"
	...
	TitleBox expworktitlebox,pos={16.00,356.00},size={228.00,28.00},title="Plot a specific time period"
	TitleBox expworktitlebox,fSize=20,frame=0
	Button Kill_All_Tables_Button,pos={678.00,119.00},size={125.00,44.00},proc=Kill_All_Tables_button,title="Kill All Tables"
	...
	Button recalc_mass,pos={280.00,145.00},size={267.00,64.00},proc=RecalcMass_Button,title="Recalculate Mass\rIf you change density, you click here \rand \"set up waves for full time series\""
	SetVariable indivfile_Y,pos={265.00,533.00},size={65.00,19.00},title="Year"
	SetVariable indivfile_Y,limits={-inf,inf,0},value= indivfile_Y
	SetVariable indivfile_Y1,pos={269.00,554.00},size={65.00,19.00},title="Month"
	SetVariable indivfile_Y1,limits={-inf,inf,0},value= indivfile_Mon
	SetVariable indivfile_Y2,pos={265.00,575.00},size={65.00,19.00},title="Day"
	SetVariable indivfile_Y2,limits={-inf,inf,0},value= indivfile_D
	SetVariable indivfile_Y3,pos={347.00,557.00},size={65.00,19.00},title="Minute"
	SetVariable indivfile_Y3,limits={-inf,inf,0},value= indivfile_Min
	SetVariable indivfile_Y4,pos={349.00,534.00},size={65.00,19.00},title="Hour"
	SetVariable indivfile_Y4,limits={-inf,inf,0},value= indivfile_H
	SetVariable indivfile_Y5,pos={348.00,578.00},size={65.00,19.00},title="Second"
	...
	SetVariable indivfile_Y6,pos={55.00,416.00},size={65.00,19.00},title="Year"
	SetVariable indivfile_Y6,limits={-inf,inf,0},value= avg_start_Y
	SetVariable indivfile_Y7,pos={57.00,436.00},size={65.00,19.00},title="Month"
	SetVariable indivfile_Y7,limits={-inf,inf,0},value= avg_start_Mon
	SetVariable indivfile_Y8,pos={56.00,459.00},size={65.00,19.00},title="Day"
	SetVariable indivfile_Y8,limits={-inf,inf,0},value= avg_start_D
	SetVariable indivfile_Y9,pos={145.00,435.00},size={65.00,19.00},title="Minute"
	SetVariable indivfile_Y9,limits={-inf,inf,0},value= avg_start_Min
	SetVariable indivfile_Y0,pos={145.00,413.00},size={65.00,19.00},title="Hour"
	SetVariable indivfile_Y0,limits={-inf,inf,0},value= avg_start_H
	SetVariable indivfile_Y06,pos={145.00,456.00},size={65.00,19.00},title="Second"
	SetVariable indivfile_Y06,limits={-inf,inf,0},value= avg_start_S
	SetVariable indivfile_Y07,pos={268.00,417.00},size={65.00,19.00},title="Year"
	SetVariable indivfile_Y07,limits={-inf,inf,0},value= avg_stop_Y
	SetVariable indivfile_Y08,pos={273.00,439.00},size={65.00,19.00},title="Month"
	SetVariable indivfile_Y08,limits={-inf,inf,0},value= avg_stop_Mon
	SetVariable indivfile_Y09,pos={271.00,461.00},size={65.00,19.00},title="Day"
	SetVariable indivfile_Y09,limits={-inf,inf,0},value= avg_stop_D
	SetVariable indivfile_Y10,pos={350.00,437.00},size={65.00,19.00},title="Minute"
	SetVariable indivfile_Y10,limits={-inf,inf,0},value= avg_stop_Min
	SetVariable indivfile_Y01,pos={350.00,415.00},size={65.00,19.00},title="Hour"
	SetVariable indivfile_Y01,limits={-inf,inf,0},value= avg_stop_H
	SetVariable indivfile_Y11,pos={350.00,458.00},size={65.00,19.00},title="Second"
	...
	SetVariable indivfile_Y12,pos={387.00,671.00},size={65.00,19.00},title="Year"
	SetVariable indivfile_Y12,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstart_Y
	SetVariable indivfile_Y13,pos={388.00,690.00},size={65.00,19.00},title="Month"
	SetVariable indivfile_Y13,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstart_M
	SetVariable indivfile_Y14,pos={387.00,714.00},size={65.00,19.00},title="Day"
	SetVariable indivfile_Y14,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstart_D
	SetVariable indivfile_Y15,pos={476.00,690.00},size={65.00,19.00},title="Month"
	SetVariable indivfile_Y15,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstop_M
	SetVariable indivfile_Y02,pos={476.00,668.00},size={65.00,19.00},title="Year"
	SetVariable indivfile_Y02,limits={-inf,inf,0},value= root:ICARTTwaves:ICARTTstop_Y
	SetVariable indivfile_Y16,pos={476.00,711.00},size={65.00,19.00},title="Day"
	...
	SetVariable Interval,pos={471.00,383.00},size={125.00,35.00},bodyWidth=21,title="\\JRPlot every nth scan\rinterval:"
	SetVariable Interval,limits={-inf,inf,0},value= Interval
	Slider slider0,pos={56.00,37.00},size={152.00,45.00}
	Slider slider0,limits={0,2,1},variable= SoftwareVersion
	Slider slider0,userTicks={VersionTypes,VersionNames}
	Button Kill_All_Data,pos={810.00,73.00},size={125.00,44.00},proc=KillAllData_button,title="Kill All Data"
	Button Kill_All_Data,help={"Kills All Data in the file"}
	Button Kill_All_Data,fColor=(65535,16385,16385)
	CheckBox Export_Check,pos={388.00,91.00},size={240.00,16.00},proc=Export_CheckProc,title="Export CSVs and figures of individual files?"
	CheckBox Export_Check,variable= Check_Box_Export_Single_File
	CheckBox Create_Symbolic_Path_for_Export_checkbox,pos={386.00,111.00},size={204.00,32.00},proc=Create_Symbolic_Path_for_Export_checkboxProc,title="Save exported files to one location?\r (Only works with multiload)"
	CheckBox Create_Symbolic_Path_for_Export_checkbox,value= 0
	TitleBox PP_title1,pos={15.00,760.00},size={140.00,28.00},title="Post-Processing"
	TitleBox PP_title1,help={"Buttons that move important waves to post-processing folder."}
	TitleBox PP_title1,fSize=20,frame=0
	Button PP_MoveWaves2PP,pos={16.00,788.00},size={178.00,21.00},proc=PP_MoveWaves2PP_button,title="Move Waves to Post-Processing"
	Button PP_CreateTime_Series1,pos={201.00,789.00},size={151.00,20.00},proc=PP_CreateTSeries_button,title="Create Time Series Graph"
	SetVariable PP_SetVar_VersionNumber,pos={160.00,767.00},size={140.00,19.00},title="Version Number"
	SetVariable PP_SetVar_VersionNumber,limits={1,inf,1},value= PP_VersionNumber
	Button PP_SetFlags_Button,pos={19.00,838.00},size={98.00,21.00},proc=PP_Set_Flags_button,title="Set Flags"
	SetVariable PP_SetVar_FlagWave_StartAdjust,pos={20.00,861.00},size={201.00,19.00},title="Flag Wave Start Index"
	SetVariable PP_SetVar_FlagWave_StartAdjust,limits={0,inf,1},value= PP_FlagWave_Start
	SetVariable PP_SetVar_FlagWave_Value,pos={22.00,902.00},size={201.00,19.00},title="Flag Wave Value"
	SetVariable PP_SetVar_FlagWave_Value,value= PP_FlagWave_Value
	SetVariable PP_SetVar_FlagWave_EndAdjust2,pos={22.00,882.00},size={201.00,19.00},title="Flag Wave End Index"
	SetVariable PP_SetVar_FlagWave_EndAdjust2,limits={0,inf,1},value= PP_FlagWave_End
	Button PP_Mask_Data_Button1,pos={120.00,837.00},size={98.00,21.00},proc=PP_Mask_Data_button,title="Mask Data"
	Button PP_CreateMaskTime_Series2,pos={23.00,813.00},size={186.00,21.00},proc=PP_CreateMaskTime_Series_button,title="Create Mask Time Series Graph"
	...
	SetVariable Bin_Number_Check_SetVar,pos={555.00,169.00},size={210.00,19.00},title="Bin Number Check"
	SetVariable Bin_Number_Check_SetVar,help={"Input the Number of Bins that is expected for each file. If one file has more or less than this number, it is not loaded. This ensures smooth concatenation for functions."}
	SetVariable Bin_Number_Check_SetVar,value= Bin_Number_Check
	Button PP_MakeICARTTTable_SMPS_button,pos={392.00,787.00},size={237.00,21.00},proc=PP_MakeICARTTTable_SMPS_button,title="Create Post Processing ICARTT Table"
	ToolsGrid visible=1
EndMacro
...
function gdatanumb()  // Load onefile files
   ...
   //Finds the expected number of bins
   NVAR Bin_Number_Check = root:Bin_Number_Check
	...
	//Before we Concatenate, check to see if the expected number of bins match what is actually seen by the program
	variable Observed_nBins = Dimsize(Diam,0)
	//If the bins that we see are the same as the bins that we expect, continue concatenation
	If(Bin_Number_Check == Observed_nBins)
		Wave NConc
		concatenate binnames, NConc 	//szdata error puts you here to fix; this error id likley due to the 710.5 diameter not having enough points as the rest of the wave
											/// Or the NConc might be a 1D wave; a bin changes midfile in this case.
	//If the bins that we see are not the same as the bins that we expect, stop processing this file and inform user
	elseif(Bin_Number_Check != Observed_nBins)
		print "" 
		print "Bin Number Check does not match with Bin numbers being read in for file " + Curr_DF_name + ", please look at AIM file for more information"
		print "" 
		killdataFolder Curr_DF
		Return -1
	Endif
...
Function gdatanumb1()  /// Load multiple files
   ...
   variable refNum    
    ...
    //Setup a list of datafolder not loaded due to bin_number_check failure
    string oddbin_list = ""
   do
   ...
   NVAR densityconv = root:density
	...
	//20240320 AJD: do not load in data with unexpected number of bins
	//Before we Concatenate, check to see if the expected number of bins match what is actually seen by the program
	variable Observed_nBins = Dimsize(Diam,0)
	//If the bins that we see are the same as the bins that we expect, continue concatenation
		If(Bin_Number_Check == Observed_nBins)
	...
	elseif(Bin_Number_Check != Observed_nBins)
		print "" 
		print "Bin Number Check does not match with Bin numbers being read in for file " + numdfr_name + ", please look at AIM file for more information"
		print ""
		oddbin_list += numdfr_name 
		killdataFolder numdfr_name
		f++
		continue 
	Endif
...
// If the Exportation Checkbox is checked, export the desired figures and CSV files
	...
	print "Bin Number Check does not match with Bin numbers being read in for file " + oddbin_list + ", please look at AIM file for more information"
End
...
Function MakeWavesForConcat()
		...
		//20240318 AJD: Nessesary explanation for NConc column redimension to avoid errors that 
		print "This code operates based on the assumption that the first data folder's data is representative of what the other folders should contain."		
		print "Ensure that AIM is inspected for these files for sources of column error."
End
...
Function/S SortedWaveList(sourceFolderStr, sortOptions)
    ...
    for (i=0; i< numDataWaves; i+=1)
        String dfName = GetIndexedObjName(sourceFolderStr, 1, i)
        dfList += dfName + ";"
    endfor
...
Function heatmap_all_cumulative_LG(type)
	...
	wave_delta = 0
	variable i 
	//20240318 AJD: Due to the code that will adjust the number of bins to the first datafolder within root:AllTime, there is no need to not make a heatmap due to different bins. The user should have already been made aware that the bins have been artifically changed. 
	for(i=1;i<ndfs;i+=1)
		...
		if (sum(wave_delta) > 0.1)
			...
			print "Although the heatmap will be produced, ensure that you are aware of the bins that have artifically been adjusted to match the first datafolder."
			//break
		endif
...
Function IrregularTime_Avg()  
	...
	//20240319 AJD: Visual Improvment -> I think the graphs would look much better if instead of 0:5:41 (for 5 min and 41 seconds past midnight it read 00:05:41)
	if(avg_Start_H<=9 && avg_Start_Min<=9 && avg_Start_S<=9)
		string str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + "0" + num2str(avg_Start_H) + ":" + "0" + num2str(avg_Start_Min) + ":"+ "0" + num2str(avg_Start_S)
	elseif(avg_Start_H>9 && avg_Start_Min<=9 && avg_Start_S<=9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + num2str(avg_Start_H) + ":" + "0" + num2str(avg_Start_Min) + ":"+ "0" + num2str(avg_Start_S)
	elseif(avg_Start_H>9 && avg_Start_min >9 && avg_Start_S<=9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + num2str(avg_Start_H) + ":" + num2str(avg_Start_Min) + ":"+ "0" + num2str(avg_Start_S)
	elseif(avg_Start_H>9 && avg_Start_Min>9 && avg_Start_S>9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + num2str(avg_Start_H) + ":" + num2str(avg_Start_Min) + ":"+ num2str(avg_Start_S)
	elseif(Avg_Start_H<=9 && Avg_Start_Min>9 && avg_Start_S<=9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + "0" + num2str(avg_Start_H) + ":" + num2str(avg_Start_Min) + ":" + "0"+ num2str(avg_Start_S)
	elseif(avg_Start_H>9 && avg_Start_min<=9 && avg_Start_S>9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " +  num2str(avg_Start_H) + ":" + "0" + num2str(avg_Start_Min) + ":" + num2str(avg_Start_S)
	elseif(Avg_Start_H<=9 && avg_Start_min>9 && avg_Start_S>9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + "0" + num2str(avg_Start_H) + ":" + num2str(avg_Start_Min) + ":" + num2str(avg_Start_S)
	elseif(Avg_Start_H<=9 && avg_Start_min<=9 && avg_Start_S>9)
		str_Start = num2str(avg_Start_Mon) + "/" + num2str(avg_Start_D) + "/" + num2str(avg_Start_Y)+ " " + "0" + num2str(avg_Start_H) + ":" + "0" + num2str(avg_Start_Min) + ":" + num2str(avg_Start_S)	
	endif
	
	
	if(avg_Stop_H<=9 && avg_Stop_Min<=9 && avg_Stop_S<=9)
		string str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + "0" + num2str(avg_stop_H) + ":" + "0" + num2str(avg_stop_Min) + ":"+ "0" + num2str(avg_stop_S)
	elseif(avg_stop_H>9 && avg_Stop_Min<=9 && avg_Stop_S<=9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + num2str(avg_stop_H) + ":" + "0" + num2str(avg_stop_Min) + ":"+ "0" + num2str(avg_stop_S)
	elseif(avg_stop_H>9 && avg_stop_min >9 && avg_Stop_S<=9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + num2str(avg_stop_H) + ":" + num2str(avg_stop_Min) + ":"+ "0" + num2str(avg_stop_S)
	elseif(avg_Stop_H>9 && avg_Stop_Min>9 && avg_Stop_S>9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + num2str(avg_stop_H) + ":" + num2str(avg_stop_Min) + ":"+ num2str(avg_stop_S)
	elseif(Avg_Stop_H<=9 && Avg_Stop_Min>9 && avg_stop_S<=9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + "0" + num2str(avg_stop_H) + ":" + num2str(avg_stop_Min) + ":" + "0"+ num2str(avg_stop_S)
	elseif(avg_stop_H>9 && avg_stop_min<=9 && avg_Stop_S>9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " +  num2str(avg_stop_H) + ":" + "0" + num2str(avg_stop_Min) + ":" + num2str(avg_stop_S)
	elseif(Avg_stop_H<=9 && avg_stop_min>9 && avg_Stop_S>9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + "0" + num2str(avg_stop_H) + ":" + num2str(avg_stop_Min) + ":" + num2str(avg_stop_S)
	elseif(Avg_stop_H<=9 && avg_stop_min<=9 && avg_Stop_S>9)
		str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + "0" + num2str(avg_stop_H) + ":" + "0" + num2str(avg_stop_Min) + ":" + num2str(avg_stop_S)	
	endif
	
	
	
	//Makes a string that includes the prescribed start and stop times ---> 20240319 AJD: Keeping old code just in case for now! 
//	string str_start = num2str(avg_start_Mon) + "/" + num2str(avg_start_D) + "/" + num2str(avg_start_Y)+ " " + num2str(avg_start_H) + ":" + num2str(avg_start_Min) + ":"+ num2str(avg_start_S)
//	string str_stop = num2str(avg_stop_Mon) + "/" + num2str(avg_stop_D) + "/" + num2str(avg_stop_Y)+ " " + num2str(avg_stop_H) + ":" + num2str(avg_stop_Min) + ":"+ num2str(avg_stop_S)
...
Function MakeICARTTTable_button(ba) : ButtonControl
	...
	switch(ba.eventCode)
		case 1: //mouse up
			...
			print "Although the ICARTT Table has been made, check the history to ensure you are aware of any matrices that were redimensioned for the purpose of concatenation."
		case 2:
			break
		endswitch
...
Function PP_MoveWaves2PP()		//AJD RETURN
...
Function PP_CreateTime_Series()
	...
	display/N=$S_Name
	Appendtograph NConc_Total_base vs datetimewave_base; AppendToGraph/R MConc_Total_base vs datetimewave_base
	label Bottom, "DateTime"
	Label right, "Mass Concentration (µg/m\S3\M)"
	Label Left, "Number Concentration (#/cm\S3\M)"
	Textbox/A=RT "Number and Mass Concentration"
...
Function PP_CreateMaskTime_Series()
	...
	setdatafolder root:Post_Processing:Unaltered_Imports:
	wave datetimewave_base, NConc_Total_base, MConc_Total_base, NConc_base, MConc_Base
	wave 'Geo.Mean(nm)_Base','Geo.Std.Dev._Base','SamplePressure(Kpa)_Base'
	wave 'SampleTemp(C)_Base', SMPS_Start_Base,SMPS_Midpoint_Base, SMPS_Stop_Base, 'TotalConc.(#/cm3)_Base'	
	DFREF PP_UI = GetdatafolderDFR()
	
	
	setdatafolder root:Post_Processing:
	DFREF PP = GetdatafolderDFR()
	//Check to see if the desired waves are already in Post_Processing
	wave Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total, Mask_NConc, Mask_MConc
	wave 'Mask_Geo.Mean(nm)', 'Mask_Geo.Std.Dev.', 'Mask_SamplePressure(Kpa)', 'Mask_SampleTemp(C)'
	wave Mask_SMPS_Midpoint, Mask_SMPS_Start, Mask_SMPS_Stop,'Mask_TotalConc.(#/cm3)'
	
	
	//If the waves exist
	if(waveexists(Mask_Datetime)==1 && waveexists(Mask_NConc_Total)==1 && waveexists(Mask_MConc_Total)==1 && waveexists(Mask_NConc)==1 && waveexists(Mask_MConc)==1 && waveexists('Mask_Geo.Mean(nm)')==1 && waveexists('Mask_Geo.Std.Dev.')==1 && waveexists('Mask_SamplePressure(Kpa)')==1 && waveexists('Mask_SampleTemp(C)')==1 && waveexists(Mask_SMPS_Midpoint)==1 && waveexists(Mask_SMPS_Start)==1 && waveexists(Mask_SMPS_Stop)==1 && waveexists('Mask_TotalConc.(#/cm3)')==1)
		string S_Name = "Mask_Post_Processing_Time_Series_Graph"
		Killwindow/Z $S_Name
		display/N=$S_Name
		Appendtograph Mask_NConc_Total vs Mask_Datetime; AppendToGraph/R Mask_MConc_Total vs Mask_Datetime
		label Bottom, "DateTime"
		Label right, "Mass Concentration (µg/m\S3\M)"
		Label Left, "Number Concentration (#/cm\S3\M)"
		Textbox/A=RT "Number and Mass Concentration"
	//If the waves don't exist
	
	
	
		elseif(waveexists(Mask_Datetime)==0 || waveexists(Mask_NConc_Total)==0 || waveexists(Mask_MConc_Total)==0 || waveexists(Mask_NConc)==0 || waveexists(Mask_MConc)==0 ||waveexists('Mask_Geo.Mean(nm)')==0 || waveexists('Mask_Geo.Std.Dev.')==0 || waveexists('Mask_SamplePressure(Kpa)')==0 || waveexists('Mask_SampleTemp(C)')==0 || waveexists(Mask_SMPS_Midpoint)==0 || waveexists(Mask_SMPS_Start)==0 || waveexists(Mask_SMPS_Stop)==0 || waveexists('Mask_TotalConc.(#/cm3)')==0)
		...
		wave 'Mask_Geo.Mean(nm)', 'Mask_Geo.Std.Dev.', 'Mask_SamplePressure(Kpa)', 'Mask_SampleTemp(C)'
		wave Mask_SMPS_Midpoint, Mask_SMPS_Start, Mask_SMPS_Stop,'Mask_TotalConc.(#/cm3)'
//		Hardcoded due to lack of knowledge
		...
		duplicate/O 'Geo.Mean(nm)_Base',PP:'Mask_Geo.Mean(nm)'
		duplicate/O 'Geo.Std.Dev._Base', PP:'Mask_Geo.Std.Dev.'
		duplicate/O 'SamplePressure(kPa)_Base',PP:'Mask_SamplePressure(Kpa)'
		duplicate/O 'SampleTemp(C)_Base',PP:'Mask_SampleTemp(C)'
		duplicate/O SMPS_Start_Base,PP:Mask_SMPS_Start
		duplicate/O SMPS_MidPoint_Base, PP:Mask_SMPS_Midpoint
		duplicate/O SMPS_Stop_Base,PP:Mask_SMPS_Stop
		duplicate/O 'TotalConc.(#/cm3)_Base', PP:'Mask_TotalConc.(#/cm3)'
		setdatafolder root:Post_Processing
		wave Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total, Mask_NConc, Mask_MConc
		wave 'Mask_Geo.Mean(nm)', 'Mask_Geo.Std.Dev.', 'Mask_SamplePressure(Kpa)', 'Mask_SampleTemp(C)'
		wave Mask_SMPS_Midpoint, Mask_SMPS_Start, Mask_SMPS_Stop//,'Mask_TotalConc.(#/cm3)'
		S_Name = "Mask_Post_Processing_Time_Series_Graph"
		Killwindow/Z $S_Name
		display/N=$S_Name
		Appendtograph Mask_NConc_Total vs Mask_Datetime; AppendToGraph/R Mask_MConc_Total vs Mask_Datetime
		label Bottom, "DateTime"
...
Function PP_Set_Flags()
	setdatafolder root:Post_Processing
	wave Flag_Wave, Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total, Mask_NConc, Mask_MConc
	setdatafolder root:
	NVAR PP_FlagWave_Start, PP_FlagWave_End, PP_FlagWave_Value
	Setdatafolder root:Post_Processing
	variable nrows = Dimsize(Mask_Datetime,0)
	...
	killwindow/Z $S_Name
	edit/N=$S_Name
	appendtotable Flag_Wave, Mask_Datetime, Mask_NConc_Total, Mask_MConc_Total, Mask_NConc, Mask_MConc
	setscale d 0,0, "dat", Mask_Datetime
	Modifytable format(Mask_DateTime) = 8 
End
...
//	Change all of the waves to the names within post processing	
	...
	Duplicate/O :'Mask_Geo.Mean(nm)' IC_W:GeoMean
	...
	Else
		Duplicate/O :'Mask_Geo.Std.Dev.' IC_W:GeoStdDev //AIM10 and Willis box
